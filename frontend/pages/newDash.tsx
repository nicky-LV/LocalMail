...
import {API_EMAIL, FolderName} from "../types";
                          ...
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y divide-gray-200">
                            <div className="pt-3 pb-2">
                              ...
                              <div className="mt-3 px-2 space-y-1">
                                <a
                                    href="#"
                                    className="block rounded-md px-3 py-2 text-base text-gray-300 font-medium hover:bg-gray-100 hover:text-white"
                                >
                                  Home
                                </a>
                                <a
                                ...
                                <a
                                    href="#"
                                    className="block rounded-md px-3 py-2 text-base text-gray-300 font-medium hover:bg-gray-100 hover:text-gray-800"
                                >
                                  Resources
                                </a>
                                <a
